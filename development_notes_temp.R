...
test@profile_plot #main plot 
test@cluster_values #hclust function output 
plot(test@cluster_values) #plot for dendrogram 
output_test_df <- test@cluster_assigned_df #cluster assignment attached to original data set 
View(output_test_df)
